...
const tiers = [
  {
    ...
    cta: 'Get Started',
    ctaHref: 'https://whop.com/halftime-hustle-nil/starter-f1/?ref=related_products&funnelId=product_71037988-1f9a-4da8-a571-76a6098e88cc',
    external: true,
    popular: false,
  },
  {
    ...
    cta: 'Join Pro',
    ctaHref: 'https://whop.com/halftime-hustle-nil/pro-e5-ed62/?ref=related_products&funnelId=product_71037988-1f9a-4da8-a571-76a6098e88cc',
    external: true,
    popular: true,
  },
  {
    ...
    description:
      'Done-for-you brand management. I handle the strategy, outreach, negotiation, and content direction so you can focus on your sport.',
    includes: [
      'Everything in Pro',
        ...
        {tier.external ? (
          ...
          <Link href={tier.ctaHref}>
            <motion.span
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="w-full flex items-center justify-center gap-2 font-tomorrow font-semibold text-sm px-6 py-3.5 rounded-xl transition-all duration-200 min-h-[48px] bg-white/5 hover:bg-white/10 text-white border border-white/10 hover:border-white/20 cursor-pointer"
            >
              {tier.cta}
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
                <path
